...
export default {
  ...
  STORAGE_CLASS_SET_DEFAULT_DESC:
    '設置為預設儲存類型後，如果没有特殊指定，系統將預設創建該類型的儲存卷。一個 Kubernetes 集群中僅允許設置一個預設儲存類型',
  ...
  VOLUME_MONITORING_TIP:
    'Kubernetes 採集的是儲存卷的設備用量數據，未掛載的儲存卷暫時採集不到，並且對於如 OpenEBS/Local PV、NFS 等路徑型儲存卷通常與實際用量有一定出入。詳見<a href="https://github.com/KylinContainerCloud/KylinContainerCloud/issues/2921" target="_blank">儲存卷監控數據分析</a>。',
}
