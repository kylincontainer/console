...
export default {
  ...
  NO_INTERNET_ACCESS_TIP:
    '目前項目中没有找到可用的網關地址，因此您無法設置應用路由。請聯繫您的項目管理員在 <strong>高級設置</strong> 中設置外網訪問方式',
  UNABLE_CREATE_ROUTE_TIP: '目前項目中没有找到可用的網關地址，無法創建應用路由',
  ...
  ACCESS_TYPES_OF_ROUTE_A:
    'KylinContainerCloud 應用路由支持自定義域名 (HostName) 的方式以及萬用字元 DNS 的訪問方式。',
}
