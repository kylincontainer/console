...
export default {
  ...
  APP_TEMPLATE_DESCRIPTION_ARTICLE:
    '通過視覺化的方式在 麒麟容器云 中展示並提供部署及管理功能，用戶可以基於應用模板快速地一鍵部署應用',

  'App README': '應用介紹',

  'The app has no documentation.': '該應用没有說明文件',
  'The version has no documentation.': '該版本没有說明文件',
  'The app has no chart file.': '該應用没有配置文件',
