...
export default {
  ...
  'get token': '获取 Token',
  'CI/CD_CREATE_DESC': `Pipeline 是一系列的插件集合，可以通过组合它们来实现持续集成和持续交付的功能。
  ...
  'Discover PR form Origin': '从原仓库中发现 PR',
  'Discover PR form Forks': '从 Fork 仓库中发现 PR',
  'Pull Strategy': '拉取策略',
  'Trusted User': '可信用户',
  'Add Action': '添加操作',
  'All branches': '所有分支',
