...
export default {
  ...
  SERVICE_CREATE_DESC:
    'Un servicio es una abstracción que define una colección lógica de Pods y una estrategia para acceder a ellos. Puedes seleccionar el tipo de servicio o cómo se crea un servicio. KylinContainerCloud admite servicios con y sin estado y los servicios se pueden crear a través de códigos o artefactos.',
