...
export default {
  ...
  WORKSPACE_OVERVIEW_DESC:
    'Workspace provides KylinContainerCloud with a secure, isolated and accessible platform. Here you can see the resource running status in the current workspace.',
  WORKSPACE_DESC:
