...
export default {
  ...
  SERVICE_COMPONENTS_DESC:
    'This module monitors the health status of various service components in KylinContainerCloud, Kubernetes, OpenPitrix and so on. It shows the health status and running time of the current cluster, and helps users monitor the status of the cluster and locate problems in time.',
  ...
  'KS-CONSOLE_DESC': 'Provides console services for KylinContainerCloud',
  OPENLDAP_DESC:
